...
function UniversityDetail() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3001/universities/${id}`)
      .then((res) => {
  ...
  return (
    <div className="relative min-h-screen font-nunito overflow-x-hidden">
      {/* Background image */}
      <div
      ...
      <div className="relative z-10 px-6 md:px-10 pt-10 text-black">
        ...
        <h4 className="text-[#fcba03] italic font-extrabold">
          {university.City_Name}, {university.Country_Name}
        </h4>
        <br />
        <div
        ...
        <h4 className="mt-6 mb-2 text-xl font-bold text-[#03fc1c]">
        ...
        {university.Programmes.length > 0 ? (
          ...
          <p className="text-[#fc0303] font-extrabold">
            No TUD programmes available at this university.
          </p>
        )}

        <h4 className="mt-8 mb-4 text-2xl font-bold text-white">
          Photo Gallery
        </h4>
      </div>
            ...
            <CardBody className="!w-80 !h-60">
              ...
              >
                <img
                  ...
                  onClick={() =>
                    openModal(`http://localhost:3001${img.Image_URL}`)
                  }
                />
              </CardItem>
              <CardItem
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-90 flex items-center justify-center">
          ...
          <div className="w-full h-full flex items-center justify-center">
            <img
              src={selectedImage}
              alt="Zoomed"
              className="max-w-full max-h-full object-contain transform hover:scale-105 transition duration-300"
            />
          </div>
        </div>
      )}
