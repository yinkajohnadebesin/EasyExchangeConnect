...
import CommentsBackground from '../assets/statics/comments.jpg';
...
function Comments() {
  ...
  const handleAddReply = async (commentId) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:3001/comments/replies", payload, {
        headers: {
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ backgroundImage: `url(${CommentsBackground})` }}
      >
        <div className="ml-10 mr-10">
          <div className="flex flex-wrap items-center gap-2">
            <ContainerTextFlip
              words={[
                "Welcome", "Fáilte", "Bienvenue", "Bienvenido", "Benvenuto",
                "Willkommen", "Welkom", "Bem-vindo", "مرحبًا", "欢迎", "स्वागत है"
              ]}
              interval={2000}
              className="text-6xl md:text-6xl font-extrabold text-blue-300"
              textClassName="text-white"
            />
            <span className="text-6xl md:text-6xl font-extrabold ml-3">
              to the EasyExchangeConnect Community!
            </span>
          </div>

          <h4 className="mb-3 font-nunito font-bold">
          ...
          <h4 className="font-nunito font-bold">
      ...
      {/* Comments Section - untouched */}
      <div className="mt-10">
        <h2 className="text-3xl font-bold ml-10 mb-4 font-nunito">Comments Section</h2>
